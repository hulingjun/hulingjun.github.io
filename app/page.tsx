...
export default function GrowthHome(){
  ...
  return <div className="archive-page"><ArchiveNav/><main className="archive-main">
    <header className="archive-intro"><div><p className="a-kicker">HULINGJUN / PERSONAL LOG</p><h1>把理解留下。<br/>把成长看见。</h1><p>一本书带来的思考，一个逐渐清晰的想法，和女儿眼里不断变大的世界。</p></div><div className="archive-intro-actions"><a className="a-button primary" href={NEW_NOTE}>＋ 记录此刻</a><a className="a-button" href="/knowledge/">整理新想法 ↗</a></div></header>
  ...
  </main><div className="archive-foot"><span>HJ / GROWTH ARCHIVE · 记录，而非赶路。</span><a href="/learning/">过往阅读实验：关键对话 ↗</a></div></div>;
}
